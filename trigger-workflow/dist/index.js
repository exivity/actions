...
// release/src/common/releaseRepositories.js
var require_releaseRepositories = __commonJS({
  "release/src/common/releaseRepositories.js"(exports2, module2) {
    "use strict";
    function resolveReleaseRepositories2(lockfile, metadata = {}, defaultBranch = "main") {
      return Object.entries(lockfile.repositories).map(([component, releasedSha]) => {
        ...
        return {
          ...
          tagStrategy: config.tagStrategy || (sourceRepo === component ? "component-repo" : "source-repo")
        };
      });
    }
