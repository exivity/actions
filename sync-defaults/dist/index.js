...
var require_v35 = __commonJS({
  "node_modules/@actions/core/node_modules/uuid/dist/v35.js"(exports) {
    ...
    exports.URL = URL2;
    function _default2(name2, version, hashfunc) {
...
function findMatchingIndex(sourceItem, target) {
  if (Object.prototype.hasOwnProperty.call(sourceItem, "name")) {
    return target.filter(
      (targetItem) => Object.prototype.hasOwnProperty.call(targetItem, "name")
...
function arrayMerge(target, source, options) {
  ...
  source.forEach((sourceItem) => {
    ...
    if (matchingIndex > -1) {
      destination[matchingIndex] = (0, import_deepmerge.default)(
...
var Branches = class extends GitHubSettingsPlugin {
  async sync() {
    return Promise.all(
      this.config.filter((branch) => branch.protection !== void 0).map((branch) => {
...
// sync-defaults/src/settings/index.ts
var CONFIG_FILENAME = ".github/settings.yml";
var PLUGINS = {
...
async function run({
  ...
  let config = {};
  for (const repo2 of [".github", repo_name]) {
    try {
...
${JSON.stringify(
        ...
        (0, import_core4.debug)(
          `Could not get settings from "exivity/${repo2}" (not a file), ignoring`
        );
      }
    } catch (error) {
      (0, import_core4.debug)(
        `Could not get settings from "exivity/${repo2}" (fetch error), ignoring`
      );
    }
  }
