...
async function run() {
  ...
  for (const version of versions) {
    ...
    if (tagOverlap) {
      (0, import_core3.info)(
        `\u{1F5D1}\uFE0F Package version ${version.id} tagged with "${(_g = (_f = (_e = version.metadata) == null ? void 0 : _e.container) == null ? void 0 : _f.tags) == null ? void 0 : _g.join(
          '","'
      ...
      (0, import_core3.info)(
        `\u2139\uFE0F Package version ${version.id} tagged with "${(_j = (_i = (_h = version.metadata) == null ? void 0 : _h.container) == null ? void 0 : _i.tags) == null ? void 0 : _j.join(
          '","'
