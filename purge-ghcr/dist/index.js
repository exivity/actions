...
async function run() {
  ...
  for (const version2 of versions) {
    ...
    if (tagOverlap) {
      (0, import_core3.info)(
        `\u{1F5D1}\uFE0F Package version ${version2.id} tagged with "${(_g = (_f = (_e = version2.metadata) == null ? void 0 : _e.container) == null ? void 0 : _f.tags) == null ? void 0 : _g.join(
          '","'
      ...
      (0, import_core3.info)(
        `\u2139\uFE0F Package version ${version2.id} tagged with "${(_j = (_i = (_h = version2.metadata) == null ? void 0 : _h.container) == null ? void 0 : _i.tags) == null ? void 0 : _j.join(
          '","'
