...
function getRepoInput(inputName = "repo", fallbackInputName = "component") {
  return fallbackInputName ? getInput(inputName) || getInput(fallbackInputName) || getRepository().repo : getInput(inputName) || getRepository().repo;
}
function getRef() {
...
async function review({
  ...
  body = `${body}${body ? "\n\n---\n\n" : ""}_Automated review from [**${getWorkflowName()}** workflow in **${repository}**](https://github.com/${repository}/actions/runs/${context.runId})_`;
