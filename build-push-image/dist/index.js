...
// build-push-image/src/index.ts
async function run() {
  const component = (0, import_core4.getInput)("component") || getRepository().component;
  const dockerfile = (0, import_core4.getInput)("dockerfile");
  const registry = (0, import_core4.getInput)("registry");
  const user = (0, import_core4.getInput)("user");
  const password = (0, import_core4.getInput)("password");
